<template>
  <div class="error-page container">
    <div class="error-card fade-up">
      ...
      <div class="error-ar ar">الصفحة غير موجودة</div>
      <h1 class="error-title">Halaman Tidak Ditemukan</h1>
      <p class="error-desc">
        Maaf, halaman atau kitab yang Anda cari tidak ditemukan atau telah dipindahkan.
        Silakan kembali ke beranda atau jelajahi koleksi kitab di katalog kami.
      </p>

      <div class="error-actions">
        <NuxtLink to="/katalog" class="btn-primary">
          Jelajahi Katalog
        </NuxtLink>
      ...
      <div class="error-categories">
        <span class="error-cat-title">Atau pilih kategori ilmu:</span>
